	...
	<div>
		...
		<v-card outlined class="mx-auto">
			<v-card outlined flat>
				<p>Elige a que concepto corresponde cada afirmación</p>
			</v-card>
			<v-container>
				<v-row dense>
					...
					<v-col v-for="(item, i) in items"
						...
						<v-card outlined class="pa-1">
							<v-list-item-title class="headline mb-1"><v-select v-model="respuestas[i]"
												:items="conceptos"
												item-text="concepto"

												dense
												solo></v-select></v-list-item-title>
